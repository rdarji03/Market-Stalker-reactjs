...
import Loader from "../Loader/SLoader"
  ...
  return (
    <>
      <section className="stock_prof flex justify-center  my-4">
        ...
        <div
          className={
            "stock_card w-[17rem]  bg-white border border-gray-900 rounded-lg shadow  dark:border-gray-700 flex justify-center flex-col items-center " +
            display
          }
        >
